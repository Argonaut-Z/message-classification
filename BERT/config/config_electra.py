...
class Config(object):
    def __init__(self, dataset):      
        ...
        self.electra_path = '/mnt/workspace/message_classification/BERT/pretrain_model/chinese-electra-base-discriminator'
        self.electra_config = ElectraConfig.from_pretrained(self.electra_path + '/config.json')
