...
class Config(object):
    def __init__(self, dataset):      
        ...
        self.nezha_path = '/mnt/workspace/message_classification/BERT/pretrain_model/nezha-cn-base'
        self.nezha_config = BertConfig.from_pretrained(self.nezha_path + '/config.json')
        self.tokenizer = BertTokenizer.from_pretrained(self.nezha_path)
