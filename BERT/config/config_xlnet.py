...
class Config(object):
    def __init__(self, dataset):      
        ...
        self.xlnet_path = '/mnt/workspace/message_classification/BERT/pretrain_model/chinese-xlnet-base'
        self.xlnet_config = XLNetConfig.from_pretrained(self.xlnet_path + '/config.json')
