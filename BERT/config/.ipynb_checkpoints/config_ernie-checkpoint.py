...
class Config(object):
    def __init__(self, dataset):      
        ...
        self.ernie_path = '/mnt/workspace/message_classification/BERT/pretrain_model/ernie-3.0-base-zh'
        self.ernie_config = BertConfig.from_pretrained(self.ernie_path + '/config.json')
