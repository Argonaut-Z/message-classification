import torch
import os
from transformers import T5ForConditionalGeneration, T5Tokenizer, BertTokenizer, T5Config
...
class Config(object):
    def __init__(self, dataset):      
        ...
        self.t5_path = '/mnt/workspace/message_classification/BERT/pretrain_model/t5-base-chinese'
        self.t5_config = T5Config.from_pretrained(self.t5_path + '/config.json')
