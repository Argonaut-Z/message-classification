...
class Config(object):
    def __init__(self, dataset):      
        ...
        self.mengzi_path = '/mnt/workspace/message_classification/BERT/pretrain_model/mengzi-bert-base'
        self.mengzi_config = BertConfig.from_pretrained(self.mengzi_path + '/config.json')
        self.tokenizer = BertTokenizer.from_pretrained(self.mengzi_path)
